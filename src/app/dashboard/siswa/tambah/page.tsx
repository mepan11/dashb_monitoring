      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Lengkapi formulir di bawah ini untuk mendaftarkan siswa baru di Lumina Scholastica.
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-[360px] flex flex-col gap-6 shrink-0">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex flex-col items-center justify-center text-center gap-4">
            ...
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-blue-50 text-[#2563eb] border border-blue-100 shadow-md flex items-center justify-center">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex flex-col gap-6">
            <div className="flex items-center justify-between text-xs font-bold">
              <span className="text-slate-700 font-extrabold text-sm">Progres Pendaftaran</span>
              <span className="text-emerald-600">75%</span>
            </div>

            {/* Progress bar */}
            <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
              <div style={{ width: "75%" }} className="h-full bg-[#2563eb] rounded-full"></div>
            </div>
