    ...
    <div className="flex flex-col gap-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="relative shrink-0">
                  <div className="w-12 h-12 rounded-full bg-blue-50/50 text-blue-600 font-bold flex items-center justify-center border border-blue-100 shadow-sm text-sm">
                    {user.initials}
                  </div>
                  <span
              ...
              <div className="grid grid-cols-2 gap-3 border-t border-slate-100/80 pt-4 mt-2">
                <Link href={`/dashboard/kelola-akun/ganti-password?id=${user.id}`}>
                ...
                <button
                  ...
                  className="py-2 px-3 rounded-xl bg-rose-50/50 hover:bg-rose-100/50 text-rose-600 font-bold text-xs transition-all"
                >
                  Hapus Akun
                </button>
              </div>
          ...
          <Link href="/dashboard/kelola-akun/tambah" className="block">
            <div className="bg-[#f4f7fc]/50 border-2 border-dashed border-slate-200/80 rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-4 cursor-pointer hover:bg-slate-100/30 transition-all min-h-[220px] h-full">
